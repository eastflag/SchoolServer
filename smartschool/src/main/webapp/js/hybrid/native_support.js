...
var NATIVE = function(){
	...
	var _CONST_COMMAND_GET_DEVICE_TYPE_AND_TOKEN= 'GET_DEVICE_TYPE_AND_TOKEN'; 	// 단말 타입과 토큰정보 가져오기 A:안드로이드 / I : iOS
	var _CONST_COMMAND_GET_PUSH_COMMAND		= 'GET_PUSH_COMMAND'; 	//푸쉬의 command 가져오기
	var _CONST_COMMAND_GET_PHOTO			= 'GET_PHOTO';					// 사진을 업로드한다.
				...
				try {
					...
					if ( commandType == _CONST_COMMAND_ALERT_TYPE_NORMAL || commandType == _CONST_COMMAND_ALERT_TYPE_CONFIRM) {
						...
						/*
							...
							commandType == _CONST_COMMAND_GET_PHOTO
						*/
						sendData = {
							'type'		: commandType
						};
	...
	return {
		...
		CONST_COMMAND_GET_DEVICE_TYPE_AND_TOKEN : _CONST_COMMAND_GET_DEVICE_TYPE_AND_TOKEN,
