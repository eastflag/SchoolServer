...
var Swiper = function(f, b) {
    ...
    function s(c) {
        ...
        if (!u || 1 == c.targetTouches.length) {
            ...
            if (b.onSlideClick || b.onSlideTouch) {
                var e = a.container, f = e.getBoundingClientRect(), g = document.body, d = d - f.left + (e.clientLeft || g.clientLeft || 0) - (window.pageXOffset || e.scrollLeft);
        ...
        if (a.isTouched&&!b.onlyExternal&&!(u && "mousemove" == c.type)) {
            ...
            if (!w)
                if (c.assignedToSwiper)
                    ...
                    if (b.resistance) {
                        if (0 < a.positions.current && (!b.freeMode || b.freeModeFluid))
                            b.loop ? (c = 1, 0 < a.positions.current && (a.positions.current = 0)) : c = (2 * l - a.positions.current) / l / 2, a.positions.current = 0.5 > c ? l / 2 : a.positions.current * c;
                            if (a.positions.current<-g() && (!b.freeMode || b.freeModeFluid))
                                b.loop ? (c = 1, d = a.positions.current, e =- g() - l) : (d = (a.touches.current - a.touches.start) * b.ratio + (g() + a.positions.start), c = (l + d) / l, d = a.positions.current - d * (1 - c) / 2, e =- g() - l / 2), a.positions.current = d < e || 0 >= c ? e : d
                    }
                    if (b.followFinger) {
    ...
    function r() {
        if (!b.onlyExternal && a.isTouched) {
            ...
            var c = a.positions.diff, d = a.positions.abs;
            5 > d && a.swipeReset();
            var e = y - l;
    ...
    if (f.nodeType || document.querySelectorAll && 0 != document.querySelectorAll(f).length) {
        ...
        for (m = a.container.childNodes.length - 1; 0 <= m; m--)
            if (a.container.childNodes[m].className)
                for (var q = a.container.childNodes[m].className.split(" "), F = 0; F < q.length; F++)
                    q[F] === b.wrapperClass && (n = a.container.childNodes[m]);
        a.wrapper = n;
        h = "horizontal" == b.mode;
        a.touchEvents = {
        ...
        a._extendSwiperSlide = function(b) {
            ...
            b.index = function() {
                for (var d, e = a.slides.length - 1; 0 <= e; e--)
                    b == a.slides[e] && (d = e);
                return d
            };
            b.isActive = function() {
        ...
        a._calcSlides = function() {
            ...
            for (var d = 0; d < a.wrapper.childNodes.length; d++)
                if (a.wrapper.childNodes[d].className)
                    for (var e = a.wrapper.childNodes[d].className.split(" "), f = 0; f < e.length; f++)
                        e[f] === b.slideClass && a.slides.push(a.wrapper.childNodes[d]);
            for (d = a.slides.length - 1; 0 <= d; d--)
                a._extendSwiperSlide(a.slides[d]);
        ...
        var A = [], t;
        for (t in a.plugins)
            b[t] && (m = a.plugins[t](a, b[t])) && A.push(m);
        ...
        if (b.loop && (k = a.slides.length, 0 != a.slides.length)) {
            m = t = "";
            for (q = 0; q < b.slidesPerSlide; q++)
                t += a.slides[q].outerHTML;
            for (q = k - b.slidesPerSlide; q < k; q++)
                m += a.slides[q].outerHTML;
        ...
        a.init = function(c) {
            var d = window.getComputedStyle(a.container, null).getPropertyValue("width"), e = window.getComputedStyle(a.container, null).getPropertyValue("height"), f = parseInt(d, 10), g = parseInt(e, 10);
            if (isNaN(f) || a.ie8 && 0 < d.indexOf("%"))
                f = a.container.offsetWidth - parseInt(window.getComputedStyle(a.container, null).getPropertyValue("padding-left"), 10) - parseInt(window.getComputedStyle(a.container, null).getPropertyValue("padding-right"), 10);
            if (isNaN(g) || a.ie8 && 0 < e.indexOf("%"))
                g = a.container.offsetHeight - parseInt(window.getComputedStyle(a.container, null).getPropertyValue("padding-top"), 10) - parseInt(window.getComputedStyle(a.container, null).getPropertyValue("padding-bottom"), 10);
            if (c ||!(a.width == f && a.height == g)) {
                if (c || B)
                    a._calcSlides(), b.pagination && a.updatePagination();
                a.width = f;
                a.height = g;
                ...
                for (g = 0; g < a.slides.length; g++) {
                    ...
                    if (b.onSlideInitialize)
                        b.onSlideInitialize(a, j)
                    }
                n.style.width = e + "px";
                n.style.height = f + "px";
            ...
            if (!(2 > a.slides.length)) {
                ...
                if (c) {
                    for (var d = 0; d < c.length; d++)
                        c.item(d).className = b.paginationClass;
        ...
        a.createPagination = function() {
            if (b.pagination && b.createPagination) {
                for (var c = "", d = a.slides.length, d = b.loop ? d - 2 * b.slidesPerSlide : d, e = 0; e < d; e++)
                    c += '<span class="' + b.paginationClass + '"></span>';
        ...
        if (b.preventLinks) {
            ...
            for (m = 0; m < t.length; m++)
                t[m].addEventListener("click", j, !1)
            }
        ...
        a.swipeNext = function(c) {
            ...
            var d = p * b.slidesPerGroup, d = Math.floor(Math.abs(c) / Math.floor(d)) * d + d;
            c = Math.abs(c);
            if (d != y && (!(c >= g()) || b.loop))
                return d > g()&&!b.loop && (d = g()), b.loop && d >= g() + l && (d = g() + l), h ? a.setTransform( - d, 0, 0) : a.setTransform(0, - d, 0), a.setTransition(b.speed), a.updateActiveSlide( - d), E(), !0
        };
        ...
        a.swipeReset = function() {
            ...
            var c = h ? a.getTranslate("x"): a.getTranslate("y"), d = p * b.slidesPerGroup, d = 0 > c ? Math.round(c / d) * d: 0, e =- g();
        ...
        a.swipeTo = function(c, d, e) {
            ...
            if (!(c > k - 1) && (!(0 > c) || b.loop))
                return e=!1 === e?!1 : e ||!0, d = 0 === d ? d : d || b.speed, b.loop && (c += b.slidesPerSlide), c > k - b.slidesPerSlide && (c = k - b.slidesPerSlide), c =- c * p, I && (b.loop && 0 < b.initialSlide && b.initialSlide < k) && (c -= b.initialSlide * p, I=!1), h ? a.setTransform(c, 0, 0) : a.setTransform(0, c, 0), a.setTransition(d), a.updateActiveSlide(c), e && E(), !0
        };
...
Swiper.prototype = {
    ...
    transitionEnd: function(f, b) {
        var g = this, j = g.wrapper, s = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"];
        if (f)
            for (var v = function() {
                f(g);
                if (!b)
                    for (var r = 0; r < s.length; r++)
                        j.removeEventListener(s[r], v, !1)
                    }, r = 0; r < s.length; r++)
                        j.addEventListener(s[r], v, !1)
    },
