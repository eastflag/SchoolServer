...
app.controller('FamilyCtrl',['$scope', '$rootScope', '$cookies', '$window', '$location', '$timeout', 'Upload', 'FamilySvc', function($scope, $rootScope, $cookies, $window, $location, $timeout, Upload, FamilySvc){
